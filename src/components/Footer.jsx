...
function Footer() {
    ...
    const socialLinks = [
        { icon: <Github className="w-5 h-5" />, href: 'https://github.com/omahajan91', label: 'GitHub' },
        { icon: <Twitter className="w-5 h-5" />, href: 'https://x.com/Om_Mahajan9477', label: 'Twitter' },
        { icon: <Linkedin className="w-5 h-5" />, href: 'https://www.linkedin.com/in/om-mahajan-43805223b/', label: 'LinkedIn' },
        { icon: <Mail className="w-5 h-5" />, href: 'mailto:omrmahajan9477@gmail.com', label: 'Email' }
    ];
